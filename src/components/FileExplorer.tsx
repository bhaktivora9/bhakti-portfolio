          ...
          <div id="file-explorer-tree-content" className="py-1">
            ...
            >
              ...
              <span id="file-explorer-project-name" className="animate-slide-in-right truncate">
                <span id="file-explorer-project-name-full" className="hidden sm:inline">BHAKTI-VORA</span>
                <span id="file-explorer-project-name-short" className="inline sm:hidden">BHAKTI</span>
              </span>
            </div>
            {isProjectExpanded && (
